...
export default async function HomePage() {
  ...
  const data = homePageApi.endpoints.getHomePublicData.select(undefined)(store.getState()).data as PublicHomePageData ?? {categories: [], popularCourses: [], promotion: undefined} as PublicHomePageData;
